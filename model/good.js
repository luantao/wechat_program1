...
const defaultDesc = ['/images/OIP.jpeg'];
...
const allGoods = [
  {
    ...
    spuId: '0',
    title: '和田玉、翡翠、和田玉',
    primaryImage: '/images/OIP.jpeg',
    images: ['/images/OIP.jpeg'],
    video: null,
    available: 1,
    minSalePrice: 29800,
    minLinePrice: 29800,
    ...
    spuTagList: [{ id: '13001', title: '和田玉、翡翠、和田玉', image: null }],
    limitInfo: [
      {
        text: '限购5件',
      },
    ],
    desc: ['/images/OIP.jpeg'],
    etitle: '和田玉、翡翠、和田玉',
  },
  {
    saasId: '88888888',
  ...
  },
  {
    ...
    spuTagList: [{ id: '19011', title: '和田玉、翡翠、和田玉', image: null }],
    spuLimitList: null,
    desc: ['/images/OIP.jpeg'],
    etitle: '和田玉、翡翠、和田玉',
  },
...
export function genGood(id, available = 1) {
  ...
  return {
    ...
    spuId: `${id}`,
    available: available,
    desc: item?.desc || ['/images/OIP.jpeg'],
    images: item?.images || ['/images/OIP.jpeg'],
  };
}
